                    ...
                    <div class="row gutters-sm">
                         <div class="col-md-4 mb-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <a href="{{ asset(''. str_replace('public/', '', $teacher->Adhaar_image)) }}" target="_blank">
                                            <img src="{{ asset(''. str_replace('public/', '', $teacher->Adhaar_image)) }}" alt="Admin" width="250" height="250">
                                        </a>
                          ...
                          <div class="card">
                            <div class="text text-center"> Degree Image</div>
                              <div class="card-body">
                                  ...
                                  <div class="d-flex flex-column align-items-center text-center">
                                      <a href="{{ asset(''. str_replace('public/', '', $teacher->Degree_image)) }}" target="_blank">
                                          <img src="{{ asset(''. str_replace('public/', '', $teacher->Degree_image)) }}" alt="Admin" width="250" height="250">
                                      </a>
